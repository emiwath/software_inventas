<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"><i class="fas fa-camera"></i> &nbsp;</h2>
	<?php }else{ ?>
...
<div class="container pb-6 pt-6">
	...
	<div class="columns">
		<div class="column is-two-fifths">
			<h4 class="subtitle is-4 has-text-centered pb-6">Foto De Usuario</h4>
		...
		<div class="column">
			<h4 class="subtitle is-4 has-text-centered pb-6"></h4>
